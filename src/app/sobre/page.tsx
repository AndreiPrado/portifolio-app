        ...
        <div className="relative z-10 flex flex-col md:flex-row gap-8">
          ...
          <div className="md:w-2/3">
            ...
            <p className="body-text mb-4">
              Front-End Software Engineer com mais de 10 anos de experiência, combinando forte expertise técnica em desenvolvimento web
              com sólidas habilidades de liderança. Especializado em JavaScript, TypeScript, Bootstrap e Liferay.
            </p>
            ...
            <p className="body-text mb-6">
              ...
              trabalhando tanto como desenvolvedor front-end quanto back-end com tecnologias como PHP, JavaScript,
              HTML, CSS e WordPress.
            </p>
            
            <p className="body-text text-gray-300 mb-8">
              Atualmente, atuo como Technical Lead na RD Saúde, supervisionando todo o escopo técnico — desde o design de arquitetura
